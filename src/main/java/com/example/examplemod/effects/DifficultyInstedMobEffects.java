...
public class DifficultyInstedMobEffects extends MobEffect {

    private final float chanceToSpawn;
    private final ToIntFunction<RandomSource> spawnedCount;

    protected DifficultyInstedMobEffects(MobEffectCategory p_330372_, int p_332310_, float p_334976_, ToIntFunction<RandomSource> p_328183_) {
    ...
    public void onMobHurt(LivingEntity p_334146_, int p_328888_, DamageSource p_330722_, float p_331740_) {
        DifficultyGeneral difficultyGeneral = ((ILevel) p_334146_.level()).getDifficultyGen();
        boolean flag = difficultyGeneral == DifficultyGeneral.INSANE || difficultyGeneral == DifficultyGeneral.NIGHTMARE;
        if (p_334146_.getRandom().nextFloat() <= this.chanceToSpawn * (flag ? p_328888_ * 2 + 1 : 1.0F)) {
