package com.example.examplemod.mixins.renders;

import com.example.examplemod.model.WardenArmorModel;
import com.example.examplemod.model.WardenModelArmor;
...
public class MixLayerDefinitions {
    @Shadow
    @Final
    ...
    public static Map<ModelLayerLocation, LayerDefinition> createRoots() {
        ...
        builder.put(ModelLayers.WARDEN, net.minecraft.client.model.WardenModel.createBodyLayer());
        builder.put(register("warden","armor"), WardenModelArmor.createBodyLayer(new CubeDeformation(2.0f)));
